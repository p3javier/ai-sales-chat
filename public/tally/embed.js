    ...
    (function (e) {
      ...
      function E(e) {
        ...
        function f(e) {
          var t = e
            ...
            n = {
              x: Number(H.width) + t.x,
              y: Number(H.height) + t.y,
            };
          _(
            B,
        ...
        "[iFrameResizerChild]Ready" === A
          ? (function () {
              for (var e in u) R("iFrame requested init", N(e), u[e].iframe, e);
            })()
          : r === ("" + A).slice(0, l) && A.slice(l).split(":")[0] in u
          ? ((I = A.slice(l).split(":")),
            (P = I[1] ? parseInt(I[1], 10) : 0),
            (L = u[I[0]] && u[I[0]].iframe),
      ...
      function j(e) {
        _(
          ...
          z(
            function () {
              M(e), R("reset", "reset", e.iframe, e.id);
            },
            e,
            "reset"
          );
              ...
              function e() {
                function e(e) {
                  ...
                  u[e] &&
                    n(u[e].iframe) &&
                    (t("height") || t("width")) &&
                    R("Visibility change", "resize", u[e].iframe, e);
                }
          ...
          : (!(function (e) {
            ...
            u[d] &&
              (u[d].iframe.iFrameResizer = {
                ...
                resize: R.bind(null, "Window resize", "resize", u[d].iframe),
                moveToAnchor: function (e) {
                  R("Move to anchor", "moveToAnchor:" + e, u[d].iframe, d);
                },
          ...
          if (null === u.querySelector('iframe[src="'.concat(m, '"]'))) {
            ...
            (O.className = "tally-loading-indicator ".concat(w)),
              ...
              "modal" === (null == t ? void 0 : t.layout)
                ...
                : (u.body.appendChild(O), u.body.appendChild(y)),
              h &&
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  u.addEventListener("scroll", function t() {
                    var o =
                      (i.document.body.scrollHeight - i.innerHeight) *
                      (n.open.scrollPercent / 100);
                    u.documentElement.scrollTop >= o &&
                      (w(e, n), u.removeEventListener("scroll", t));
                  });
                }
              else {
                u.addEventListener("mouseout", function t(o) {
                  o.toElement ||
                    o.relatedTarget ||
                    (w(e, n), u.removeEventListener("mouseout", t));
                });
              }
            else
              setTimeout(function () {
                ...
                switch (t.replace("tally-", "")) {
                  ...
                  case "emoji-text":
                    u.emoji = r(
                      ...
                      {
                        text: e,
                        animation: c.get("tally-emoji-animation"),
                      }
                    );
                    break;
                  case "auto-close":
